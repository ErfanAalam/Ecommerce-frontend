...
const AppWrapper = () => {
  ...
  function isAddToCart(id) {
    const isProductAdded = cartItem.find((addedproduct) => {
  ...
  return (
    ...
    >
      <div
        className={`h-20 px-10 text-white flex justify-between items-center sticky top-0 z-50`}
        style={{ backgroundColor: Color.primary }}
      >
        <a href="/">
          <h1 className="text-3xl  font-bold mt-4">ClothHub</h1>
        </a>
        <ul className="text-xl flex gap-10 ">
          {user !== null ? (
            <div className="flex gap-2 ">
              <li className="hidden md:block">Welcome {user.displayName}</li>
              <a href="/signup" onClick={handleLogout}>
                <li>
                  <LogoutIcon />
                </li>
              </a>
          ...
          <div className="relative w-8">
            ...
            <p className="absolute top-[-1rem] right-0 text-center w-6 h-6 rounded-full pt-[2px] bg-gray-500">
              {cartItem.length}
            </p>
          </div>
        </ul>
      ...
      <div
        className={`h-10 border-t-2 border-black hidden md:flex items-center justify-center px-10 bg-[${Color.secondary}]`}
      ...
      >
        <ul className="text-lg flex justify-evenly items-center w-full">
          ...
          <a className="li" href="/products">
            <li>Products</li>
          </a>
          <a className="li" href="/blog">
            {" "}
            <li>Blog</li>
          </a>
